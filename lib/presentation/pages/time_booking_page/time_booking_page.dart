...
import 'package:flix_movie/presentation/pages/time_booking_page/methods/options.dart';
...
class _TimeBookingPageState extends ConsumerState<TimeBookingPage> {
  ...
  final List<int> hours = List.generate(7, (index) => (index * 2) + 12);
                  ...
                  child: ElevatedButton(
                      ...
                      onPressed: () {
                        if (selectedDate == null ||
                          ...
                          context.showSnacBar('Please select all options');
                        } else {
